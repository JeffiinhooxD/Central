...
public class DeputadoEstadual extends Candidato {
     ...
     */
    public DeputadoEstadual(String nome, String cpf, int numero, Partido partido, Estado estado) throws CpfException {
        super(nome, cpf, numero, partido);
        this.estado = estado;
    }
    
    /**
     * Pega o estado do deputado estadual.
    ...
    /**
     * Seta o estado do deputado estadual.
