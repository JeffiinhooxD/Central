...
public class DeputadoFederal extends javax.swing.JFrame {
     ...
     */
    public DeputadoFederal(CandidatoDAO candidatoDAO, PartidoDAO partidoDAO) {
        ...
        /*Seta o foco no nome*/
        texNomeDeputadoFederal.requestFocus();
    }
    ...
    public void camposObrigatorios() throws CampoObrigatorioException {
        ...
        if (texCpfDeputadoFederal.getText().equals("   .   .   -  ")) campo = "CPF";
        if (texNumeroDeputadoFederal.getText().equals("    "))        campo = "NUMERO";
        if (texNomeDeputadoFederal.getText().equals(""))              campo = "NOME";
    ...
    private void initComponents() {
        ...
        texNomeDeputadoFederal = new javax.swing.JTextField();
        texNumeroDeputadoFederal = new javax.swing.JTextField();
        try{
            javax.swing.text.MaskFormatter formataNumero = new javax.swing.text.MaskFormatter("####");
            texNumeroDeputadoFederal = new javax.swing.JFormattedTextField(formataNumero);
        }catch(Exception e){
        }
        jLabel4 = new javax.swing.JLabel();
        texCpfDeputadoFederal = new javax.swing.JTextField();
        try{
            javax.swing.text.MaskFormatter formataCpf = new javax.swing.text.MaskFormatter("###.###.###-##");
            texCpfDeputadoFederal = new javax.swing.JFormattedTextField(formataCpf);
        }catch(Exception e){
        ...
        jLabel1.setText("Deputado Federal");
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                    .addComponent(texNumeroDeputadoFederal, javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(texNomeDeputadoFederal)))
                            .addGroup(layout.createSequentialGroup()
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                ...
                                .addGap(28, 28, 28)
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(texCpfDeputadoFederal)
                                    .addGroup(layout.createSequentialGroup()
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel2)
                    .addComponent(texNomeDeputadoFederal, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel3)
                    .addComponent(texNumeroDeputadoFederal, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel4)
                    .addComponent(texCpfDeputadoFederal, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel5)
                    .addComponent(boxPartido, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void btnLimparActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLimparActionPerformed
        ...
        texNomeDeputadoFederal.setText("");
        texNumeroDeputadoFederal.setText("");
        
        /*O cpf nao limpa direito (olhar depois)*/
        texCpfDeputadoFederal.setText(null);
    ...
    private void btnConfirmarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnConfirmarActionPerformed
        ...
        try {
            ...
            modelo.DeputadoFederal deputadoFederal = 
                    new modelo.DeputadoFederal(texNomeDeputadoFederal.getText(),
                                                texCpfDeputadoFederal.getText(),
                                                Integer.parseInt(texNumeroDeputadoFederal.getText()),
            ...
            candidatoDAO.igualdadeCandidato(deputadoFederal);
            
            /*Se o deputado federal pode ser cadastrado entao cadastra no dao, no arquivo e envia pro drive*/
            candidatoDAO.inserir(deputadoFederal);
            
            try {
                candidatoDAO.inserirJson(deputadoFederal);
            } catch (Exception ex) {
                JOptionPane.showMessageDialog(this, "Houve algum erro ao salvar o deputado federal no arquivo json.", "Erro", JOptionPane.ERROR_MESSAGE);
                return ;
            }
    ...
    private javax.swing.JTextField texCpfDeputadoFederal;
    private javax.swing.JTextField texNomeDeputadoFederal;
    private javax.swing.JTextField texNumeroDeputadoFederal;
